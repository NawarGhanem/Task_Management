...
class HardwareAdd extends StatefulWidget {
  const HardwareAdd({super.key});

  @override
  State<HardwareAdd> createState() => _HardwareAddState();
}

class _HardwareAddState extends State<HardwareAdd> {
