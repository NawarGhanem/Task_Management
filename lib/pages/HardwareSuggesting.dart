...
import 'package:supervisor/pages/AddSuggesting.dart';
import 'package:supervisor/pages/HardwareBrows.dart';
...
class HardwareSuggesting extends StatefulWidget {
  const HardwareSuggesting({super.key});

  @override
  State<HardwareSuggesting> createState() => _HardwareSuggestingState();
}

class _HardwareSuggestingState extends State<HardwareSuggesting> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(onPressed: (){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>AddSuggesting()));
          ...
          children: [
            ...
            Expanded(
              child: InkWell(
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => HardwareBrows()));
                },
                child: Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    color: const Color.fromARGB(255, 85, 159, 220),
                  ),
                  child: Center(
                      child: Text(
                    "Browse",
            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(10),
                  color: Color.fromARGB(255, 7, 89, 130),
                ),
                child: Center(
                    child: Text(
                  "Suggestions",
