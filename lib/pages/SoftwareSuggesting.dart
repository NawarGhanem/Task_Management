...
import 'package:supervisor/pages/SoftwareBrows.dart';
...
class SoftwareSuggesting extends StatefulWidget {
  const SoftwareSuggesting({super.key});

  @override
  State<SoftwareSuggesting> createState() => _SoftwareSuggestingState();
}

class _SoftwareSuggestingState extends State<SoftwareSuggesting> {
