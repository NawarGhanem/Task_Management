...
import 'package:supervisor/pages/NetworkBrowse.dart';
...
class NetworkSuggesting extends StatefulWidget {
  const NetworkSuggesting({super.key});

  @override
  State<NetworkSuggesting> createState() => _NetworkSuggestingState();
}

class _NetworkSuggestingState extends State<NetworkSuggesting> {
