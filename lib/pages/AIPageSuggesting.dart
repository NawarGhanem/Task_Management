...
import 'package:supervisor/pages/AIPageBrows.dart';
...
class AIPAgeSuggesting extends StatefulWidget {
  const AIPAgeSuggesting({super.key});

  @override
  State<AIPAgeSuggesting> createState() => _AIPAgeSuggestingState();
}

class _AIPAgeSuggestingState extends State<AIPAgeSuggesting> {
