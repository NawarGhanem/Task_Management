...
import 'package:supervisor/pages/SoftwareSuggesting.dart';
...
class SoftwareBrows extends StatefulWidget {
  const SoftwareBrows({super.key});

  @override
  State<SoftwareBrows> createState() => _SoftwareBrowsState();
}

class _SoftwareBrowsState extends State<SoftwareBrows> {
