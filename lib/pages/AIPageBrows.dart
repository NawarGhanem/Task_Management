...
import 'package:supervisor/pages/AIPageSuggesting.dart';
...
class AIPageBrows extends StatefulWidget {
  const AIPageBrows({super.key});

  @override
  State<AIPageBrows> createState() => _AIPageBrowsState();
}

class _AIPageBrowsState extends State<AIPageBrows> {
