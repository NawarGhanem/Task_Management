...
import 'package:supervisor/pages/NetworkSuggesting.dart';
...
class NetworkBrowse extends StatefulWidget {
  const NetworkBrowse({super.key});

  @override
  State<NetworkBrowse> createState() => _NetworkBrowseState();
}

class _NetworkBrowseState extends State<NetworkBrowse> {
